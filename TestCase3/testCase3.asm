...
.data		
		...
		sizeB:	.word	79
		.origin 0x2
		STRING1: .word  "ComputerArchitectureIsTheArtOfSelectingAndInterconnectingHardwareComponentsToCreateComputersThatMeetCertainGoals\0"		//Starts at address 2 for testing right now
		.origin 0x202
		STRING2: .word  "FlynnSTaxonomyIsAClassificationOfComputerArchitecturesProposedByMichaelJFlynnIn1966\0"	//Start at address 202 for testing right now